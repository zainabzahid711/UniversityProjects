...
if(isset($_POST['submit'])){
  ...
  $sql = "insert into beechsupplies_services(name,email,address,product,quantity,time) values('$name','$email','$address','$product','$quantity','$time')";
...
<body class="homeContainer">
  ...
  <div class="contactFormMain content content-check">
    ...
    <form action="beachSupplies.php"method="post">
      <div class="inputDiv">
      ...
      <button class="navbutton submit-contact " type="submit" name="submit" onclick="redirectToConfirm()"> Order Confirm</button>
